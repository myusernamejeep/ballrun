...
function step() {
	...
	if (player.object.GetWorldCenter().y > canvasHeight){
		player.object.SetPosition(new b2Vec2(20,0),0)
	}	
	else if (player.object.GetWorldCenter().x > canvasWidth-50){
		showWin();
		return;	
	}
...
function showWin(){
	...
	ctx.fillText('Yay! you made it!', 30, 0);
	ctx.fillText('thank you, ballrun!', 30, 30);
	ctx.fillText('@ballrun', 30, 60);	
}
